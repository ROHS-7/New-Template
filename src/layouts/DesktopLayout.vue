<template>
  <div id="zoom">
    ...
    <div class="relative z-[1000]">
      <div class="pb-[30px] xl:px-0 px-3">
      ...
      <div class="bg-black pt-[30px] xl:px-0 px-3">
        <div class="grid md:grid-cols-8 grid-cols-1 gap-6">
          <div>
...
// In your <script setup> or component logic
import { ref, onMounted, onUnmounted } from "vue";

const updateScale = () => {
  const baseWidth = 1440; // your design's original width
  const screenWidth = window.innerWidth;

  // Set a scale factor based on screen width
  let zoomValue = Math.min(screenWidth / baseWidth, 1); // don't upscale
  document.getElementById("zoom").style.zoom = zoomValue;
};
