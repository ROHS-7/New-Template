<template>
  <div>
    ...
    <div class="relative z-[100]">
      ...
      >
        <img
          class="w-[366px] absolute h-[120px] top-[40px] object-contain transition-all duration-700"
          :src="logoImage"
          :class="{
        ...
        />
        <img
          class="w-[366px] h-[120px] top-[40px] absolute transition-all duration-700 object-contain"
          :src="gameType.image"
          v-for="gameType in gameTypes"
          :key="gameType.type"
          :class="{
        ...
        <img
          ...
          :class="{
            '!translate-y-[0] scale-90  !translate-x-[0px]':
              currentGameType === gameType.type,
            'translate-y-[-500%] scale-[0.1] translate-x-[200%]':
              currentGameType !== gameType.type,
          }"
          alt=""
        />
