<template>
  <Navbar />
  <div class="mt-[70px]">
    <HomeSlider slides-per-view="1" />
  </div>
  <div class="flex w-full items-center gap-3 my-3">
    <PrimaryDarkBtn class="w-full" text="Register" />
    <PrimaryLightBtn class="w-full" text="Login" />
  </div>
  <div class="mb-3">
    <Marquee />
  </div>
  ...
  >
    <div
      ...
      :style="{
        background:
          currentFilter === route.path.split('/')[1]
            ? 'linear-gradient(165.34deg, rgb(51, 255, 0) -17.16%, rgb(51, 153, 51) 91.36%)'
            : 'none',
        boxShadow:
          currentFilter === route.path.split('/')[1]
            ? 'rgb(55, 156, 53) 0px 0px 7.5px 0px'
            : 'none',
      }"
    >
      <div
        v-html="route.icon"
        class="text-primary"
        :class="{ 'text-white': currentFilter === route.path.split('/')[1] }"
      />
      <p
        class="text-primary text-[14px] pt-1 font-semibold"
        :class="{ 'text-white': currentFilter === route.path.split('/')[1] }"
      >
        {{ route.text }}
      </p>
  ...
  <div class="flex gap-2">
    <div class="sticky top-[60px] h-fit z-[98]">
      <div class="flex flex-col gap-2.5 justify-start items-center pl-1">
        <RouterLink
          :to="link.path"
          class="w-[60px] h-[60px] transition-all flex items-center justify-center flex-col rounded-md"
          v-for="link in navLinks"
          :key="link.text"
          :style="{
            background:
              currentRoute == link.path ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 0)',
            boxShadow:
              currentRoute == link.path
                ? 'rgb(255, 255, 255) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.247) 0px 4px 4px 0px, rgba(0, 0, 0, 0.247) 0px -2px 1px 0px inset, rgba(0, 0, 0, 0.247) 0px 4px 4px 0px'
                : 'rgb(0, 0, 0) 0px 2px 4px 0px inset, rgba(0, 0, 0, 0.247) 0px 4px 4px 0px, rgba(0, 0, 0, 0.247) 0px -2px 1px 0px inset, rgba(0, 0, 0, 0.247) 0px 4px 4px 0px',
          }"
        >
          <img
            class="w-[34px] transition-all h-[30px] object-contain"
            :class="{ 'scale-[1.5]': currentRoute == link.path }"
            :src="link.image"
            alt=""
          />
          <p
            class="text-[10px] text-white font-semibold"
            :class="{ '!text-black': currentRoute == link.path }"
          >
            {{ link.text }}
          </p>
        </RouterLink>
  ...
  <div class="mt-7">
    <div
      class="w-full h-[134px] border-[1.5px] relative border-white/50 rounded-[7px] p-3 overflow-hidden"
    >
      <div class="absolute top-0 left-0 right-0 bottom-0 pointer-events-none">
        <svg
          class="absolute top-0 right-0 bottom-0 pointer-events-none"
          width="396"
          height="134"
          viewBox="0 0 396 134"
          fill="none"
        ...
        >
          <g clip-path="url(#clip0_18_314)">
            <rect width="396" height="134" fill="#000000"></rect>
            <g opacity="0.7" style="mix-blend-mode: exclusion">
              <rect
                width="148"
                height="148"
                transform="matrix(-1 0 0 1 148 -0.999939)"
                fill="url(#pattern0_18_314)"
              ></rect>
              <rect
                width="148"
                height="148"
                transform="matrix(-1 0 0 1 296 -0.999939)"
                fill="url(#pattern1_18_314)"
              ></rect>
              <rect
                width="148"
                height="148"
                transform="matrix(-1 0 0 1 444 -0.999939)"
                fill="url(#pattern2_18_314)"
              ></rect>
            </g>
            <g style="mix-blend-mode: overlay">
              <ellipse
                ...
                rx="228"
                ry="167.5"
                transform="rotate(180 400 117.5)"
                fill="url(#paint0_radial_18_314)"
                fill-opacity="0.3"
              ></ellipse>
            </g>
            <g style="mix-blend-mode: overlay">
            ...
            <ellipse
              ...
              rx="187.5"
              ry="138.5"
              transform="rotate(180 10.5 -0.499938)"
              fill="url(#paint5_radial_18_314)"
              fill-opacity="0.3"
            ></ellipse>
          </g>
          <defs>
            ...
            >
              <use
                xlink:href="#image0_18_314"
                transform="translate(-1) scale(0.000488281)"
              ></use>
            </pattern>
            <pattern
              id="pattern1_18_314"
            ...
            <radialGradient
              id="paint0_radial_18_314"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(398.843 115.618) rotate(90) scale(154.326 190.458)"
            >
              <stop
                offset="0.348958"
                stop-color="#e6ffe0"
                stop-opacity="0.6"
              ></stop>
              <stop offset="1" stop-color="#33ff00" stop-opacity="0"></stop>
            </radialGradient>
            <radialGradient
              id="paint1_radial_18_314"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
            ...
            <radialGradient
              id="paint5_radial_18_314"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(9.54825 -2.05612) rotate(90) scale(127.607 156.627)"
            >
              <stop
                offset="0.348958"
                stop-color="#e6ffe0"
            ...
            <clipPath id="clip0_18_314">
              <rect width="396" height="134" fill="white"></rect>
            </clipPath>
            <image
              id="image0_18_314"
              width="5396"
              height="1848"
              href="https://alpha7s.online/images/shortcut/bg_card.png"
            ></image>
          </defs>
        </svg>
      </div>
      <div class="absolute top-0 right-0 bottom-0 pointer-none">
        <img
          class="w-full h-full object-contain"
          src="https://alpha7s.online/images/shortcut/bg_card_cover.webp"
          alt=""
        />
      </div>
      <div class="relative flex flex-col justify-between h-full">
        <div class="flex items-center gap-2">
          <img
            ...
            src="https://cdn.zabbet.com/0VNF/lobby_settings/f413e08b-e1f8-4b95-bb72-5641096d9ba2.png"
            alt=""
          />
          <div>
        ...
        <div class="flex items-center text-white gap-1">
          ...
          <p class="text-white underline text-xs">Introductions install app</p>
        </div>
        <div class="flex items-center gap-3">
          <div
            class="p-[1px] rounded-[7px] cursor-pointer"
            style="
          ...
          >
            <div
              class="flex w-[100px] text-white justify-center h-[32px] rounded-[7px] bg-black items-center gap-2"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
          ...
          >
            <div
              class="flex w-[100px] text-[rgb(113, 113, 113)] justify-center h-[32px] rounded-[7px] bg-black items-center gap-2"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
  ...
  <div>
    <p class="md:font-semibold text-white text-sm mt-[50px] text-center">
      Payment Method
    </p>
  ...
  <div
    class="flex items-center border-t-[1px] border-t-white/30 pt-[10px] justify-between mt-[40px]"
  >
    <div class="flex flex-col">
      <p class="text-white text-sm">Contact</p>
    ...
    <div>
      <div class="text-white text-sm">Responsible for betting</div>
  ...
  <div
    class="flex gap-3 mt-7 border-t-[1px] border-t-white/30 pt-[10px] justify-between"
  >
    <div class="xl:col-span-3 lg:col-span-4 md:col-span-6">
      <p class="text-[#7CA9B7] font-normal text-sm flex flex-col">
        <span class="font-semibold text-white">Licenses and certificates</span>
        <span class="text-white/60 text-[12px]"
          >"(Guaranteed authentic licensed game)"</span
        >
      </p>
      <div class="mt-3 flex flex-wrap gap-6 items-center">
        <img
          loading="lazy"
          class="max-h-[32px]"
          alt="Image 1"
    ...
    <div class="flex shrink-0 gap-12">
      <div>
        <div class="text-white text-sm">Support and security by</div>
...
const currentFilter = ref("highlights");
